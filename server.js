...
cloudinary.config({ 
  cloud_name: 'docy1tbio', 
  api_key: '521238135463275', 
  api_secret: 'L-hbrd1s7AQtZGMicsoRFmr25w8' 
});


const mongoDB = "mongodb+srv://bohdan16022005:dAOLx5itz6jBccCW@cluster0.f9slmxd.mongodb.net/?retryWrites=true&w=majority";
...
app.post("/products", (req, res) => {
  ...
  form.parse(req, async (err, fields, files) => {
    ...
    const { productId, productName, productSocket, productChipset, productDimm, productForm_Factor, oldCloudinaryPublicId, oldImagePath } = fields;
